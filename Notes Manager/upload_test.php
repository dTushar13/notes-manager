...
<!-- Data Insertion in table and Deletion Process -->
			...
			<?php
			 ...
			 ?>	
			        ...
			        <td><br><a href='download.php?id=<?php echo $document['_id'];?>' >Document</a></td> 

			       <td><br><a href='upload_test.php?id=<?php echo $document['_id'];?>' >Delete</a><br><br><a href='update.php?id=<?php echo $document['_id'];?>' name='update'>Update</a><br></td>
